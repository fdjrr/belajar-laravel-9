...
class DashboardPostController extends Controller
{
  ...
  public function store(Request $request)
  {
    ...
    if ($request->file('image')) $validatedData['image'] = $request->file('image')->store('posts-images');
  ...
  public function update(Request $request, Post $post)
  {
    ...
    if ($request->slug != $post->slug) $validated['slug'] = ['required', 'unique:posts'];
