...
@section('contents')
		...
		<form action="/dashboard/posts" method="POST" enctype="multipart/form-data">
            ...
            @enderror" id="inputTitle">
				...
				<div class="mb-3">
						...
						<input type="name" name="slug" value="{{ old('slug') }}"
        ...
        @enderror" name="category_id"
				...
				<div class="mb-3">
						...
						<img src="" alt="" class="img-preview img-fluid col-sm-5 img-thumbnail mb-3">
            ...
            @enderror" type="file"
				...
				<div class="mb-3">
						<input type="hidden" name="body" id="content" value="{{ old('body') }}">
